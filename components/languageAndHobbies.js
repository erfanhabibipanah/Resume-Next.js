            ...
            <div className="container" style={{
                ...
                <div className={styles.ResumeLanguagesAndHobbiesBlocklanguages}>
                    <div className={styles.ResumeLanguagesAndHobbiesBlocklanguage}>
                        <div className={styles.ResumeLanguagesAndHobbiesBlocklanguageTitleAndLevel}>
                            <span className={styles.ResumeLanguagesAndHobbiesBlocklanguageTitle}>
                                Persian
                            </span>
                            <br />
                            <span className={styles.ResumeLanguagesAndHobbiesBlocklanguageLevel}>
                                Native
                            </span>
                        </div>
                        <DotsProgress
                            maxNumberOfDots={10}
                            numberOfActiveDots={10}
                        />
                    </div>
                    <div className={styles.ResumeLanguagesAndHobbiesBlocklanguage}>
                        <div className={styles.ResumeLanguagesAndHobbiesBlocklanguageTitleAndLevel}>
            ...
            <div className={styles.ResumeLanguagesAndHobbiesBlockhobbies}>
                <div className={styles.ResumeLanguagesAndHobbiesBlockhobbycontainer}>
                    <div className={styles.ResumeLanguagesAndHobbiesBlockhobby}>
                        <Card className={styles.ResumeLanguagesAndHobbiesBlockhobbyfront} style={{backgroundColor: "rgb(33, 150, 243)"}}>
                            <CardContent>
                                <SportsEsportsIcon fontSize="large" style={{ color: "white" }} />
                                <h4 style={{color: "#ffffff"}}>Game</h4>
                            </CardContent>
                        </Card>
                        <Card className={styles.ResumeLanguagesAndHobbiesBlockhobbyback} style={{color: "#ffffff", backgroundColor: "rgb(33, 150, 243)"}}>
                            <CardContent>
                                <div className={styles.ResumeLanguagesAndHobbiesBlockhobbybackdescription}>
                ...
                <div className={styles.ResumeLanguagesAndHobbiesBlockhobbycontainer}>
                    <div className={styles.ResumeLanguagesAndHobbiesBlockhobby}>
                        <Card className={styles.ResumeLanguagesAndHobbiesBlockhobbyfront} style={{backgroundColor: "rgb(33, 150, 243)"}}>
                            <CardContent>
                                <AirplanemodeActiveIcon fontSize="large" style={{ color: "white" }} />
